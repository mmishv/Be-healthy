...
-- Started on 2023-05-20 23:30:28
...
--
-- TOC entry 3241 (class 2604 OID 27254)
...
--
-- TOC entry 3240 (class 2604 OID 27214)
...
--
-- TOC entry 3253 (class 2604 OID 27524)
...
--
-- TOC entry 3248 (class 2604 OID 27476)
...
--
-- TOC entry 3251 (class 2604 OID 27496)
...
--
-- TOC entry 3233 (class 2604 OID 27189)
...
--
-- TOC entry 3244 (class 2604 OID 27299)
...
--
-- TOC entry 3239 (class 2604 OID 27205)
...
--
-- TOC entry 3255 (class 2604 OID 28418)
...
--
-- TOC entry 3271 (class 2606 OID 27218)
...
--
-- TOC entry 3273 (class 2606 OID 27216)
...
--
-- TOC entry 3275 (class 2606 OID 27258)
...
--
-- TOC entry 3287 (class 2606 OID 27529)
...
--
-- TOC entry 3289 (class 2606 OID 27860)
...
--
-- TOC entry 3283 (class 2606 OID 27481)
...
--
-- TOC entry 3285 (class 2606 OID 27865)
...
--
-- TOC entry 3277 (class 2606 OID 27284)
...
--
-- TOC entry 3281 (class 2606 OID 27314)
...
--
-- TOC entry 3263 (class 2606 OID 27200)
...
--
-- TOC entry 3265 (class 2606 OID 27198)
...
--
-- TOC entry 3226 (class 2606 OID 28749)
-- Name: profile profile_age_check; Type: CHECK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE public.profile
    ADD CONSTRAINT profile_age_check CHECK ((age > 10)) NOT VALID;


--
-- TOC entry 3227 (class 2606 OID 28752)
-- Name: profile profile_cal_norm_check; Type: CHECK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE public.profile
    ADD CONSTRAINT profile_cal_norm_check CHECK ((cal_norm > (0)::numeric)) NOT VALID;


--
-- TOC entry 3228 (class 2606 OID 28755)
-- Name: profile profile_carb_norm_check; Type: CHECK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE public.profile
    ADD CONSTRAINT profile_carb_norm_check CHECK ((carb_norm > (0)::numeric)) NOT VALID;


--
-- TOC entry 3257 (class 2606 OID 27142)
...
--
-- TOC entry 3229 (class 2606 OID 28754)
-- Name: profile profile_fats_norm_check; Type: CHECK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE public.profile
    ADD CONSTRAINT profile_fats_norm_check CHECK ((fats_norm > (0)::numeric)) NOT VALID;


--
-- TOC entry 3230 (class 2606 OID 28751)
-- Name: profile profile_height_check; Type: CHECK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE public.profile
    ADD CONSTRAINT profile_height_check CHECK ((height > 100)) NOT VALID;


--
-- TOC entry 3259 (class 2606 OID 27144)
...
--
-- TOC entry 3261 (class 2606 OID 27140)
...
--
-- TOC entry 3231 (class 2606 OID 28753)
-- Name: profile profile_prot_norm_check; Type: CHECK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE public.profile
    ADD CONSTRAINT profile_prot_norm_check CHECK ((prot_norm > (0)::numeric)) NOT VALID;


--
-- TOC entry 3232 (class 2606 OID 28750)
-- Name: profile profile_weight_check; Type: CHECK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE public.profile
    ADD CONSTRAINT profile_weight_check CHECK ((weight > (30)::numeric)) NOT VALID;


--
-- TOC entry 3267 (class 2606 OID 27209)
...
--
-- TOC entry 3269 (class 2606 OID 27207)
...
--
-- TOC entry 3279 (class 2606 OID 27304)
...
--
-- TOC entry 3291 (class 2606 OID 28422)
...
--
-- TOC entry 3293 (class 2606 OID 28420)
...
--
-- TOC entry 3295 (class 2606 OID 28454)
...
--
-- TOC entry 3304 (class 2606 OID 28669)
-- Name: ingredient ingredient_product_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.ingredient
    ADD CONSTRAINT ingredient_product_id_fkey FOREIGN KEY (product_id) REFERENCES public.product(id) ON UPDATE CASCADE ON DELETE CASCADE NOT VALID;


--
-- TOC entry 3305 (class 2606 OID 28674)
...
--
-- TOC entry 3302 (class 2606 OID 27972)
...
--
-- TOC entry 3303 (class 2606 OID 27977)
...
--
-- TOC entry 3301 (class 2606 OID 27487)
...
--
-- TOC entry 3296 (class 2606 OID 28387)
...
--
-- TOC entry 3297 (class 2606 OID 28392)
...
--
-- TOC entry 3299 (class 2606 OID 28397)
...
--
-- TOC entry 3300 (class 2606 OID 28402)
...
--
-- TOC entry 3294 (class 2606 OID 28425)
...
--
-- TOC entry 3298 (class 2606 OID 28449)
...
-- Completed on 2023-05-20 23:30:28
