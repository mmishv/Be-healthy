...
<% ArrayList<ArticleCategory> cats = new ObjectMapper().readValue(request.getAttribute("categories").toString(),
        new TypeReference<ArrayList<ArticleCategory>>() {
        });
  request.setAttribute("categories", cats);
%>
<fmt:requestEncoding value="UTF-8"/>
<form method="post" action="create_article" accept-charset="utf-8">
  <fieldset class="form-group">
    <div class="wrapper col-sm-9" style="margin: auto;">
      <div class="form-group row">
        ...
        <div class="col-sm-8">
          <input class="form-control" name="title" id="article-title"
