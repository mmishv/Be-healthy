...
<div class="wrapper row">
    ...
    <div class="col-sm-10 rec">
        <h3 class="header">Список рецептов</h3>

        <div class="form-group">
            <input class="form-control" id="search" placeholder="Поиск по названию рецепта..." autocomplete="off"
        ...
        <div class="scroll-table">
            <table class="table table-striped recipes">
                ...
                <tr>
                    ...
                    <th scope="col" style="width: 32%;">Название рецепта</th>
            ...
            <div class="scroll-table-body">
                <table class="table table-striped recipes" id="table-search">
                    ...
                    <tr>
                        <td>1</td>
                        <td class="searchable">Нисуаз</td>
                        <td>салаты, беременность, вегетерианство</td>
                        <td>
