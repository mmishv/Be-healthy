                        ...
                        <tr>
                            ...
                            <td>
                                <div class="control-buttons">
                                    <button type="submit" title="Назначить администратором" onclick="changeProfileRole('${profile.id}')">
                                    ...
                                    <button type="submit" title="Удалить пользователя" name="delete" onclick="deleteProfile('${profile.id}')">
